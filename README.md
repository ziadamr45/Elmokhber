...
| ![Ably](https://img.shields.io/badge/Ably-FF5C5C?style=flat) | مراسلة في الوقت الحقيقي |
...
cp .env.example .env
# عدّل ملف .env بإعدادات LiveKit وقاعدة البيانات
...
| ![Ably](https://img.shields.io/badge/Ably-FF5C5C?style=flat) | Real-time Messaging |
